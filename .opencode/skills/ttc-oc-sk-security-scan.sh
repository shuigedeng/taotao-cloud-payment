#!/bin/bash
# taotao-cloud-payment 安全扫描脚本
# 用于检查 DDD 项目中的常见安全问题

echo "================================================"
echo "  taotao-cloud-payment 安全扫描"
echo "================================================"

# 扫描配置
BASE_DIR="."
MODULES=("taotao-cloud-payment-api" "taotao-cloud-payment-application" "taotao-cloud-payment-domain" "taotao-cloud-payment-infrastructure" "taotao-cloud-payment-interfaces")
HAS_WARNINGS=0
